...
class Report:
    ...
    # Define functions for creating each element
    ...
    # Define function for creating the table of contents page
    ...
    # Define function for building the report
    def build(self):
        try:
...
# Define a function to test the template
