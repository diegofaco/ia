...
def create_main_window():
    ...
    generate_button = tk.Button(window, text="Generate Sentences", command=lambda: generate_and_display_sentences(num_sentences_spinbox, text_area, progress_bar, templates, words_by_pos))
